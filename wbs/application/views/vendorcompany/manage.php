...
<!-- End .title -->
            ...
            <div class="content">
                <form autocomplete="off" class="form-horizontal cmxform" id="validateForm" action="<?php echo site_url("vendorcompany/update"); ?>" method="post" enctype="multipart/form-data">

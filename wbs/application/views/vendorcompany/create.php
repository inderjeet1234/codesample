            ...
            <div class="title">
                <h4>
                    ...
                    <span>Create Vendor Company</span>
                </h4>
            </div>
            <!-- End .title -->
                        ...
                        <div class="content">
                            ...
                            <form id="validateForm"  class="form-horizontal cmxform" autocomplete="off"  action="<?php echo site_url("vendorcompany/save"); ?>" method="post" enctype="multipart/form-data">
                               ...
                               <div class="form-row control-group row-fluid">
                                ...
                                <div class="form-actions row-fluid">
                                    <div class="span7 offset3">
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="window.location='<?php echo site_url("vendorcompany");?>'">Cancel</button>
                                    </div>
                                </div>
                            </form>
                        </div>

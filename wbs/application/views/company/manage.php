...
<!-- End .title -->
            ...
            <div class="content">
                <form autocomplete="off" class="form-horizontal cmxform" id="validateForm" action="<?php echo site_url("company/update"); ?>" method="post" enctype="multipart/form-data">
                 ...
                 <!--   <div class="form-row control-group row-fluid">
                    ...
                    <div class="form-row control-group row-fluid">
                        <label class="control-label span3" for="admin_name">Admin Full Name</label>
                        <div class="controls span7">

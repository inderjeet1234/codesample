...
<div class="title">
    ...
    <h2>
        <i class=" icon-bar-chart"></i> <span>Inactive Projects</span>
    </h2>
    ...
    <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
        ...
        <tr>
            ...
            <td class="ms"><div class="btn-group1">
                      ...
                      <a href="<?php echo site_url('home/inactiveprojectposts/id/'.$val->id);?>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Assign Users">View Posts</i></a>

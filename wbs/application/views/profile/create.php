...
<div class="content">
    <form id="validateForm"  class="form-horizontal cmxform" autocomplete="off"  action="<?php echo site_url("profile/save"); ?>" method="post" enctype="multipart/form-data">

        <div class="form-row control-group row-fluid">
            <label class="control-label span3" for="company_name">Name</label>
        ...
        <div class="form-row control-group row-fluid">
            ...
            <div class="controls span7">
                <input readonly="readonly" required type="email" value="<?php echo $val['email'];?>" id="email" name="email" class="row-fluid">
            </div>
        </div>
        ...
        <div class="form-row control-group row-fluid">
            <label class="control-label span3">Send Email Notification</label>
            <div class="controls span7">

                <label class="inline radio">
                    <input type="radio" name="sendemail" value="1" <?php if($val['sendEmail']==1) echo 'checked="CHECKED"';?> /> Active </label>
                <label class="inline radio">
                    <input type="radio" name="sendemail" value="2" <?php if($val['sendEmail']==2) echo 'checked="CHECKED"';?>/> Inactive </label>
            </div>
        </div>
        ...
        ?>
        <div class="form-row control-group row-fluid ">
            <label class="control-label span3">Project Based Notification </label>
            <div class="controls span7">
                <?php
                foreach($projects as $proval)
                {
                ?>
                <label class="checkbox ">
                    <input type="checkbox" id="pro_<?php echo $proval->id;?>" name="pro_<?php echo $proval->id;?>" <?php if($proval->isnotification==1)echo "checked='checked'";?>  value="1"><?php echo $proval->project_name;?> </label>
...
<div class="form-actions row-fluid">
    <div class="span7 offset3">
        ...
        <button type="button" onclick="window.location='<?php echo site_url("home");?>'" class="btn btn-secondary">Cancel</button>
    </div>
</div>
</form>
</div>

...
<div class="title">
    ...
    <h2>
        <i class=" icon-bar-chart"></i> <span>Manage Client Companies</span>
    </h2>
...
<div class="row-fluid control-group">
    <div class="pull-left span6" action="#">
        ...
        <div class=" ">
            ...
            <button type="button" class="btn inline" onclick="window.location='<?php echo site_url("clientcompany/create");?>'">Create New Client Company</button>
    ...
    <div style="float:right;" class="dataTables_filter" id="datatable_example_filter">
        <form action="<?php echo site_url("clientcompany"); ?>" method="post" id="search">
        ...
        <tr>
           <!-- <td><label class="checkbox "><input type="checkbox"></label></td>-->
            ...
            <td class="ms"><div class="btn-group1">
                    <a href="<?php echo site_url('clientcompany/manage/id/'.$val->id);?>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a>
            ...
            <div class="pagination pull-right ">
               <ul>
                   ...
                   if($limit>1)
                   {
                       ...
                       <li><a href="<?php echo site_url('clientcompany/index/limit/'.$prev);?>">Prev</a></li>
                   <?php
                   }
                   ...
                   {
                   ?>
                    <li><a href="<?php echo site_url('clientcompany/index/limit/'.$k);?>" <?php if($limit==$k) echo "style='font-weight:bold;'";?>><?php echo $k;?></a></li>
                   <?php
                         }
                   ?>
                   ...
                   {
                       ?>
                       <li><a href="<?php echo site_url('clientcompany/index/limit/'.$next);?>">Next</a></li>
                   <?php
                   }

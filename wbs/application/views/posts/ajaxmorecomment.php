...
<div class="post_replies" id="axcd<?php echo  $val['id']; ?>"><!---postreplies---->
                        <div class="post_reply">
                            ...
                            <img class="thumbnail small"  style=" width:50px; height: 50px; both" src="<?php echo base_url();?>img/admincompany/<?php if(!empty($userdata->pic))echo $userdata->pic;else echo "default.jpg"; ?>"/></a>

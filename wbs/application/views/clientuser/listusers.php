...
<div class="title">
    ...
    <h2>
        <i class=" icon-bar-chart"></i> <span>Manage Client Users</span>
    </h2>
...
<div class="row-fluid control-group">
    <div class="pull-left span6" action="#">
        ...
        <div class=" ">
            ...
            <button type="button" class="btn inline" onclick="window.location='<?php echo site_url("clientuser/create");?>'">Create New Client User</button>
    ...
    <div style="float:right; width:405px;" class="dataTables_filter" id="datatable_example_filter">
        <?php if($this->session->userdata('company_type')==1)
        {
            ...
            <div class="controls " style="float:left; width: 120px;">
                <select data-placeholder="Choose your favorite character..." class="chzn-select" id="companiesfilters" name="companiesfilters" style="width:160px; margin-left:10px;"  onchange="window.location='<?php echo site_url('clientuser/users/filtersbycompanies') ?>'+'/'+this.value">
        ...
        ?>
        <form action="<?php echo site_url("clientuser/users"); ?>" method="post" id="search">
    ...
    <table  class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
        ...
        <tr>
           <!-- <td><label class="checkbox "><input type="checkbox"></label></td>-->
            ...
            <td><?php echo $this->clientusermodel->getcompanyname($val->company_id);?></td>
            <td><?php echo $val->email;?></td>
            <td class="to_hide_phone"><?php echo $val->contact_number;?></td>


            <td class="ms"><div class="btn-group1">
                    <a href="<?php echo site_url('clientuser/create/id/'.$val->id);?>" class="btn btn-small"  rel="tooltip" data-placement="left" data-original-title=" Edit "><i class="gicon-edit"></i></a>
            ...
            <div class="pagination pull-right ">
               <ul>
                   ...
                   if($limit>1)
                   {
                       ...
                       <li><a href="<?php echo site_url('clientuser/users/limit/'.$prev);?>">Prev</a></li>
                   <?php
                   }
                   ...
                   {
                   ?>
                    <li><a href="<?php echo site_url('clientuser/users/limit/'.$k);?>" <?php if($limit==$k) echo "style='font-weight:bold;'";?>><?php echo $k;?></a></li>
                   <?php
                         }
                   ?>
                   ...
                   {
                       ?>
                       <li><a href="<?php echo site_url('clientuser/users/limit/'.$next);?>">Next</a></li>
                   <?php
                   }

            ...
            <div class="title">
                <h4>
                    ...
                    <span><?php if($this->uri->segment(4)) echo 'Edit User';else echo 'Create  User';?></span>
                </h4>
            </div>
            <!-- End .title -->
                        ...
                        <div class="content">
                            ...
                            <form id="validateForm"  class="form-horizontal cmxform" autocomplete="off"  action="<?php echo site_url("mainuser/save"); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-actions row-fluid">
                                    <div class="span7 offset3">
                                        ...
                                        <button type="button" onclick="window.location='<?php echo site_url("mainuser/users");?>'" class="btn btn-secondary">Cancel</button>
                                    </div>
                                </div>
                            </form>
                        </div>

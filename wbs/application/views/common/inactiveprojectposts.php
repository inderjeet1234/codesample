                      ...
                      <div class="text">
                          <?php echo $val->description; ?>
                           <?php if(!empty($val->attachments)){?>
                            <img  style="width:300px;border:1px solid #eee;padding:5px;" src="<?php echo base_url();?>img/posts/<?php echo $val->attachments; ?>"/>
                            <?php
							}
							?>
                                                ...
                                                <div class="imgupload">
                                                    <?php if(!empty($tdsf->attachment))
                                                    {
                                                        ...
                                                        foreach($img as $vall)
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <a href="<?php echo base_url();?>/uploads/<?php echo $vall;?>" target="_blank">  <img src="<?php echo base_url();?>/uploads/<?php echo $vall;?>"    style="width:300px;border:1px solid #eee;padding:5px;"/></a>
                                                            <?php
                                                            }
                                                            else
                                                            {

...
<table  width="500" border="0" cellspacing="5" cellpadding="5">
		   ...
		   <tr>
			 <td height="22" colspan="2" align="left" valign="top" style="font-size:14px;">A new post - <b><?php echo $post_title;?></b> in the Project - <b><?php echo $project_name;?></b> has been received for approval.</td>
		   </tr>

            ...
            <!-- End .title -->
                        ...
                        <div class="content">
                            <form onsubmit="return validateforma()" id="validateForm"  class="form-horizontal cmxform" autocomplete="off"  action="<?php echo site_url("assignprojects/save"); ?>" method="post" enctype="multipart/form-data">


                                <div class="form-row control-group row-fluid">
                                    <label class="control-label span3" for="company_name">Company Name</label>
                                    <div class="controls span7">
                                        <input required type="text" id="name" name="name" readonly="readonly" value="<?php echo $company_name;?>" class="row-fluid">
                                    </div>
                                </div>
                                ...
                                <div class="form-row control-group row-fluid">
                                    ...
                                    <div class="controls span7">
                                        <input required type="text" id="name" name="name" readonly="readonly" value="<?php echo $project_name;?>" class="row-fluid">
                                    </div>
                                </div>
                                ...
                                <div class="form-row control-group row-fluid">
                                    ...
                                    <div class="controls span7">
                                        ...
                                        <label class="inline radio">
                                            <input type="radio" name="add_vendors_to_project" value="1"  /> Yes </label>
                                        <label class="inline radio">
                                            <input type="radio" name="add_vendors_to_project" value="2" checked="CHECKED" /> No </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-row control-group row-fluid">
                                    ...
                                    <div class="controls span7">
                                        ...
                                        <label class="inline radio">
                                            <input type="radio" name="app_for_wbs" value="1"  /> Yes </label>
                                        <label class="inline radio">
                                            <input type="radio" name="app_for_wbs" value="2" checked="CHECKED" /> No </label>
                                    </div>
                                </div>
                                  <div id="appwbsddv">
                                ...
                                <div class="form-row control-group row-fluid">
                                    ...
                                    <div class="controls span7">
                                        ...
                                        <label class="inline radio">
                                            <input type="radio" name="app_for_client"   value="1"  /> Yes </label>
                                        <label class="inline radio">
                                            <input type="radio" name="app_for_client" value="2" checked="CHECKED" /> No </label>
                                    </div>
                                </div>
                                <div id="appclientddv">

...
class Vendorcompany extends Base_Controller {
    ...
    public function create()
    {
        ...
        $this->load->view('vendorcompany/create');
    ...
    public function manage()
    {
        ...
        $this->load->model('vendorcompanymodel','',true);
        $data['val']=$this->vendorcompanymodel->getcompanydetails();

        $this->load->view('common/header');
        $this->load->view('common/left');
        $this->load->view('common/main',$data);
        $this->load->view('vendorcompany/manage');
        $this->load->view('common/footer');
    ...
    function index()
    {
        ...
        {
            $data['total_rows'] = $this->db->query("select * from company where company_type=3 and company_name  LIKE '".$this->input->post('searchfil')."%' ")->num_rows();
            $data['data']=$this->vendorcompanymodel->getcompanies();
        ...
        else
        {
            ...
            $data['total_rows'] = $this->db->get_where('company',array('company_type'=>3))->num_rows();
            ...
            $this->load->model('vendorcompanymodel','',true);
            $data['data']=$this->vendorcompanymodel->getcompanies($data['startlimit'],$data['per_page']);
        }
        ...
        $this->load->view('common/left');
        $this->load->view('common/main');
        $this->load->view('vendorcompany/listusers',$data);
        $this->load->view('common/footer');
